...
In order to support loading of multiple wallets in indinode-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is indinode.cpp.
...
Changes to indinode.cpp
----------------------
indinode.cpp is the entry point into indinode-qt, and as such, will require some minor modifications to provide hooks for
