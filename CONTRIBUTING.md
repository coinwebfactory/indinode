Contributing to IndiNode Core
============================

The IndiNode Core project operates an open contributor model where anyone is
...
Examples:
    ...
    Consensus: Add new opcode for BIP-XINDX OP_CHECKAWESOMESIG
...
The following applies to code changes to the IndiNode Core project, and is not to be
confused with overall IndiNode Network Protocol consensus changes.

Whether a pull request is merged into IndiNode Core rests with the project merge
...
Patches that change IndiNode consensus rules are considerably more involved than
...
Where a patch set proposes to change the IndiNode consensus, it must have been
...
The project leader is the release manager for each IndiNode Core release.
