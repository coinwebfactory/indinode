...
RESOURCES += src/qt/indinode.qrc src/qt/indinode_locale.qrc

TRANSLATIONS += src/qt/locale/indinode_bg.ts \
                src/qt/locale/indinode_de.ts \
                src/qt/locale/indinode_en.ts \
                src/qt/locale/indinode_es.ts \
                src/qt/locale/indinode_fi.ts \
                src/qt/locale/indinode_fr.ts \
                src/qt/locale/indinode_it.ts \
                src/qt/locale/indinode_ja.ts \
                src/qt/locale/indinode_pl.ts \
                src/qt/locale/indinode_pt.ts \
                src/qt/locale/indinode_ru.ts \
                src/qt/locale/indinode_sk.ts \
                src/qt/locale/indinode_sv.ts \
                src/qt/locale/indinode_vi.ts \
                src/qt/locale/indinode_zh_CN.ts \
                src/qt/locale/indinode_zh_TW.ts
