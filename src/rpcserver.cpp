...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop IndiNode server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "IndiNode server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* IndiNode features */
        {"indinode", "masternode", &masternode, true, true, false},
        {"indinode", "listmasternodes", &listmasternodes, true, true, false},
        {"indinode", "getmasternodecount", &getmasternodecount, true, true, false},
        {"indinode", "masternodeconnect", &masternodeconnect, true, true, false},
        {"indinode", "masternodecurrent", &masternodecurrent, true, true, false},
        {"indinode", "masternodedebug", &masternodedebug, true, true, false},
        {"indinode", "startmasternode", &startmasternode, true, true, false},
        {"indinode", "createmasternodekey", &createmasternodekey, true, true, false},
        {"indinode", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"indinode", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"indinode", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"indinode", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"indinode", "getmasternodescores", &getmasternodescores, true, true, false},
        {"indinode", "mnbudget", &mnbudget, true, true, false},
        {"indinode", "preparebudget", &preparebudget, true, true, false},
        {"indinode", "submitbudget", &submitbudget, true, true, false},
        {"indinode", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"indinode", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"indinode", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"indinode", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"indinode", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"indinode", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"indinode", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"indinode", "checkbudgets", &checkbudgets, true, true, false},
        {"indinode", "mnsync", &mnsync, true, true, false},
        {"indinode", "spork", &spork, true, true, false},
        {"indinode", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"indinode", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use indinoded, or the -server option to indinode-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> indinode-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:6970/\n";
}
