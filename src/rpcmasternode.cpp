...
Value obfuscation(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() == 0)
        throw runtime_error(
            "obfuscation <indinodeaddress> <amount>\n"
            "indinodeaddress, reset, or auto (AutoDenominate)"
    ...
    if (params.size() != 2)
        throw runtime_error(
            "obfuscation <indinodeaddress> <amount>\n"
            "indinodeaddress, denominate, or auto (AutoDenominate)"
            "<amount> is a real and will be rounded to the next 0.1" +
            HelpRequiringPassphrase());
...
Value getpoolinfo(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "\nResult:\n"
            "{\n"
            "  \"current\": \"addr\",    (string) IndiNode address of current masternode\n"
            "  \"state\": xindx,        (string) unknown\n"
            "  \"entries\": xindx,      (numeric) Number of entries\n"
            "  \"accepted\": xindx,     (numeric) Number of entries accepted\n"
            "}\n"
...
Value masternode(const Array& params, bool fHelp)
{
    ...
    if (fHelp ||
        ...
        throw runtime_error(
            ...
            "  start        - Start masternode configured in indinode.conf\n"
...
Value listmasternodes(const Array& params, bool fHelp)
{
    ...
    if (fHelp || (params.size() > 1))
        throw runtime_error(
            ...
            "    \"addr\": \"addr\",      (string) Masternode IndiNode address\n"
...
Value masternodeconnect(const Array& params, bool fHelp)
{
    if (fHelp || (params.size() != 1))
        throw runtime_error(
            ...
            "\nExamples:\n" +
            HelpExampleCli("masternodeconnect", "\"192.168.0.6:6969\"") + HelpExampleRpc("masternodeconnect", "\"192.168.0.6:6969\""));
...
Value masternodecurrent (const Array& params, bool fHelp)
{
    if (fHelp || (params.size() != 0))
        throw runtime_error(
            ...
            "\nResult:\n"
            "{\n"
            "  \"protocol\": xindx,        (numeric) Protocol version\n"
            "  \"txhash\": \"xindx\",      (string) Collateral transaction hash\n"
            "  \"pubkey\": \"xindx\",      (string) MN Public key\n"
            "  \"lastseen\": xind,       (numeric) Time since epoch of last seen\n"
            "  \"activeseconds\": xind,  (numeric) Seconds MN has been active\n"
            "}\n"
            "\nExamples:\n" +
...
Value startmasternode (const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 2 || params.size() > 3 ||
        ...
        throw runtime_error(
            ...
            "{\n"
            "  \"overall\": \"xindx\",     (string) Overall status message\n"
            "  \"detail\": [\n"
            "    {\n"
            "      \"node\": \"xindx\",    (string) Node name or alias\n"
            "      \"result\": \"xindx\",  (string) 'success' or 'failed'\n"
            "      \"error\": \"xindx\"    (string) Error message, if failed\n"
            "    }\n"
            "    ,...\n"
            "  ]\n"
            "}\n"
...
Value getmasternodeoutputs (const Array& params, bool fHelp)
{
    if (fHelp || (params.size() != 0))
        throw runtime_error(
            ...
            "[\n"
            "  {\n"
            "    \"txhash\": \"xindx\",    (string) output transaction hash\n"
...
Value listmasternodeconf (const Array& params, bool fHelp)
{
    ...
    if (fHelp || (params.size() > 1))
        throw runtime_error(
            ...
            "[\n"
            "  {\n"
            "    \"alias\": \"xindx\",        (string) masternode alias\n"
            "    \"address\": \"xindx\",      (string) masternode IP address\n"
            "    \"privateKey\": \"xindx\",   (string) masternode private key\n"
            "    \"txHash\": \"xindx\",       (string) transaction hash\n"
            "    \"outputIndex\": n,       (numeric) transaction output index\n"
            "    \"status\": \"xindx\"        (string) masternode status\n"
            "  }\n"
            "  ,...\n"
            "]\n"
...
Value getmasternodestatus (const Array& params, bool fHelp)
{
    if (fHelp || (params.size() != 0))
        throw runtime_error(
            ...
            "  \"netaddr\": \"xindx\",     (string) Masternode network address\n"
            "  \"addr\": \"xindx\",        (string) IndiNode address for masternode payments\n"
            "  \"status\": \"xindx\",      (string) Masternode status\n"
            "  \"message\": \"xindx\"      (string) Masternode status message\n"
            "}\n"
...
Value getmasternodewinners (const Array& params, bool fHelp)
{
    if (fHelp || params.size() > 3)
        throw runtime_error(
            ...
            "    \"winner\": {\n"
            "      \"address\": \"xindx\",    (string) IndiNode MN Address\n"
...
Value getmasternodescores (const Array& params, bool fHelp)
{
    if (fHelp || params.size() > 1)
        throw runtime_error(
            ...
            "\nResult:\n"
            "{\n"
            "  xindx: \"xindx\"   (numeric : string) Block height : Masternode hash\n"
            "  ,...\n"
            "}\n"
            "\nExamples:\n" +
