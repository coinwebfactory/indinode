                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("IndiNode Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a IndiNode address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and indinode: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zXIND"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About IndiNode Core"), this);
    aboutAction->setStatusTip(tr("Show information about IndiNode Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for IndiNode"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your IndiNode addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified IndiNode addresses"));
    ...
    openAction->setStatusTip(tr("Open a IndiNode: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the IndiNode Core help message to get a list with possible IndiNode command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("IndiNode Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to IndiNode network", "", count));
}
...
{
    QString strTitle = tr("IndiNode Core"); // default title
