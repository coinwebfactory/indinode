                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received Xind from zXind"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zXind"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zXind));
