...
/** Utility functions used by the IndiNode Qt UI.
 */
namespace GUIUtil
{
...
// Render IndiNode addresses in monospace font
...
// Parse "indinode:" URI into recipient object, return true on successful parsing
