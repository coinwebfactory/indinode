...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("IndiNode Core indinode-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  indinode-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded indinode transaction") + "\n" +
                               "  indinode-tx [options] -create [commands]   " + _("Create hex-encoded indinode transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded indinode transaction
